<%-- 
    ...
    Created on : Oct 2, 2017, 3:37:56 PM
    Author     : Admin
--%>
                ...
                <div id="content">
                    ...
                    <div class="products">
                        ...
                        <form action="ControllerProducts">
                            <table class="insert">
                                <tr><td>Code</td><td><input type="text" name="txtCode" value="${SP.code}"/></td></tr>
                                <tr><td>Name</td><td><input type="text" name="txtName" value="${SP.name}"/></td></tr>
                                <tr><td>Price</td><td><input type="text" name="txtPrice" value="${SP.price}"/></td></tr>
                                <tr><td>Image</td><td><input type="file" name="txtImage" value="${SP.image}"/></td></tr>
                            </table>
                            <input style='margin-left: 65px; height: 30px; width: 60px;' type="submit" name="action" value="Update"/>
                        </form>
                        <div class="cl">&nbsp;</div>
                    </div>
                    <!-- End Products -->
